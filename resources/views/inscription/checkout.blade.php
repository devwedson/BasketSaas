        ...
        <div class="p-6 space-y-4">
            @if (!empty($missingPayment))
                <div class="p-4 rounded bg-warning/10 text-warning">
                    Nenhuma cobrança de inscrição foi encontrada para sua conta.
                    Peça ao administrador do clube para vincular seu acesso em <strong>Comissão Técnica</strong> e gerar a cobrança.
                </div>
            @else
                <dl class="grid gap-3">
